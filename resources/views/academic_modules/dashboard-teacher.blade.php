				...
				<div class="col-lg-2 col-xs-6">
					...
					<div class="small-box bg-green">
						<div class="inner">
							...
							<p class="text-bold" style="font-size: 20px">Gradebook</p>
						</div>
						<div class="icon" style="color: #FFFFFF;">
							<i class="fa fa-sort-numeric-desc" aria-hidden="true"></i>
						</div>
						<a href="{{url('/academics/manage/assessments/grade-book')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<!-- ./col -->
				<div class="col-lg-2 col-xs-6">
