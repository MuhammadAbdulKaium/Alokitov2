                                        ...
                                        <td>
                                            ...
                                            <div class="checkbox form-group">
                                                <label>
                                                    ...
                                                    <input type="hidden" id='{{$allSubjects[($x).""]["id"]}}_sg' value='
                                                    @if($allSubjects[($x).""]["check_sub_group_assign_single"])
                                                        @if ($allSubjects[($x).""]["check_sub_group_assign_single"]["subject_group_single"])
                                                            {{$allSubjects[($x).""]["check_sub_group_assign_single"]["subject_group_single"]["id"]}}
                                                        @endif
                                                    @endif'>
                                                    <input type="hidden" >
