            ...
            <section class="content">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> Stock In List</h3>
                        <div class="box-tools">
                            <a class="btn btn-success btn-sm" @click="openModal('addForm', 'stock-in-data/create',true)"><i class="fa fa-plus-square"></i> New</a></div>
                    </div>
                    <div class="box-body">
                        <form action="" class="form-inline">
                            <div class="row" style="margin-bottom: 10px">
                                ...
                                <div class="col-sm-3">
                                    <multiselect :select-label="''" :deselect-label="''" v-if="dataList.voucher_list" name="voucher_id_model" v-model="filter.voucher_id_model" :options="dataList.voucher_list"  placeholder="Select voucher" label="voucher_no" track-by="id" @input="selectVoucher" :options-limit="10000" :disabled="false"></multiselect>
                                </div>
                                <div class="col-sm-3">
                            ...
                            <table class="table table-striped table-bordered m-b-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sortable" v-bind:class="getSortingClass('inventory_direct_stock_in_details.status')" @click="sortingChanged('inventory_direct_stock_in_details.status')">Status</th>
                                        <th>Remarks</th>
                                        <th>Approved By</th>
                                ...
                                <tbody>
                                    <template v-if="Object.keys(paginate_data).length > 0">
                                        <tr v-for="(list, index) in paginate_data" v-bind:key="index">
                                            ...
                                            <td>@{{(list.category=='opening')?'Opening':'Direct Purchase'}}</td>
                                            ...
                                            <td>
                                                <a v-if="list.has_approval=='yes'" class="btn btn-primary btn-xs" @click="voucherApproval('stock-in-approval',list.id)"
                                                ><i class="fa fa-check-square" aria-hidden="true"></i> Approved</a>
                                                <a v-if="list.status==0" class="btn btn-primary btn-xs" @click="openModal('addForm', 'stock-in-data/'+list.stock_in_id+'/edit')" title="Edit"><i class="fa fa-edit"></i></a>
                                                ...
                                                <a class="btn btn-primary btn-xs" @click="openModal('detailsForm', 'stock-in-data/'+list.stock_in_id)" 
                        ...
                        <div class="row">
                            <div class="col-sm-2 p-t-15">
                                ...
                                <!-- <button @click="voucherApproval('stock-in-approval',0)" class="btn btn-info">Approve</button> -->
                            </div>
            ...
            <div class="modal-content" v-if="!pageLoader">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <span v-if="formData.id">Edit Stock In</span>
                        <span v-else>Add Stock In</span>
                    </h4>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Stock In Details
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8 p-b-15">
                                    @{{(formData.category=='opening')?'Opening':'Direct Purchase'}}    
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <div class="modal" id="serialForm" tabindex="-1" role="dialog" aria-labelledby="esModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" v-if="!pageLoader">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" @click="selectSerial('stock-in')">Select</button>
                    <button type="button" class="btn" data-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
    ...
    var app = new Vue({
      ...
      methods:{
        ...
        itemGridAdd(event){
            ...
            if(this.gridData.item_id && parseFloat(this.gridData.qty)>0 && parseFloat(this.gridData.rate)>0 && this.gridData.remarks){
        ...
        initNewVoucherData(){
            const _this = this;
            let URL = _this.baseUrl + '/stock-in-data/create';
