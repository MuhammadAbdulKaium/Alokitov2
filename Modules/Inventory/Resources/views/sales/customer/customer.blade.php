            ...
            <section class="content">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <a class="btn btn-success btn-sm" href="{{ url('inventory/customer-data/create') }}"><i class="fa fa-plus-square"></i> New</a></div>
                    </div>
                    <div class="box-body">
                                ...
                                <tbody>
                                    <template v-if="Object.keys(paginate_data).length > 0">
                                        <tr v-for="(list, index) in paginate_data" v-bind:key="index">
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-xs" :href="baseUrl+'/customer-data/'+list.id+'/edit'" title="Edit"><i class="fa fa-edit"></i></a>
                                                ...
                                                <a class="btn btn-primary btn-xs" :href="baseUrl+'/customer-data/'+list.id"   @click="openModal('detailsForm', 'customer-data/'+list.id)" 
