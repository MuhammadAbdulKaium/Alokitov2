            ...
            <section class="content">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <a class="btn btn-success btn-sm" @click="openModal('addForm', 'purchase-receive-data/create',true)"><i class="fa fa-plus-square"></i> New</a></div>
                    </div>
                    <div class="box-body">
                                    ...
                                    <template v-if="Object.keys(paginate_data).length > 0">
                                        <tr v-for="(list, index) in paginate_data" v-bind:key="index">
                                            ...
                                            <td>
                                                ...
                                                <a v-if="list.status==0" class="btn btn-primary btn-xs" @click="openModal('addForm', 'purchase-receive-data/'+list.pur_receive_id+'/edit')" title="Edit"><i class="fa fa-edit"></i></a>
                                                ...
                                                <a class="btn btn-primary btn-xs" @click="openModal('detailsForm', 'purchase-receive-data/'+list.pur_receive_id)" 
