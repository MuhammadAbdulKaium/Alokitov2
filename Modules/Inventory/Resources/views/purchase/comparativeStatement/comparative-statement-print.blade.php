...
<head>
    ...
    <title>Purchase comparative-statement</title>
    <style>
        .clearfix {
            overflow: auto;
        }
...
<body>
    ...
    <div class="content clearfix">
        ...
        <h1 class="text-center" style="margin-bottom: 0px; font-size:20px">Purchase comparative Statement(PCS)</h1>

        <div class="clearfix">
            <div class="top-table" style="margin-top: 10px;">
                <table>
                    <tbody>
                        <tr>
                            <td>
                        ...
                        @foreach ($voucherDetailsData as $data)
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ (int) $data->net_amount }}
                                    @php
                                        $totalNetAmount += $data->net_amount;
                                    @endphp
                                </td>
                                <td>
                                    {{ $data->remarks }}
