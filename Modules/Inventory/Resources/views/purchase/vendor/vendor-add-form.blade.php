    ...
    <div class="content-wrapper">
        <div v-if="!pageLoader">
            <section class="content-header">
                <h1>
                    <i class="fa fa-plus-square"></i> Add New Vendor
                </h1>
                <ul class="breadcrumb">
            ...
            <section class="content">                
                <form  class="form-horizontal" @submit.prevent="submitVendorForm()">
                <div class="box box-solid">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="file" name="" class="form-control" @change="onFileChange($event, 'vendor_image')" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary" :disabled="buttonDisabled">Create</button>   <a class="btn btn-default" href="{{url('inventory/vendor')}}">Cancel</a>
                    </div>
                </div>
                </form>
            </section>
...
<script>
    ...
    var app = new Vue({
      ...
      created(){
        this.formPageData('vendor-create-form-data');
      },
      methods:{
        submitVendorForm(formData = this.formData) {
            const _this = this;
                    ...
                    axios.post(URL, formReqData, {
                        ...
                        if (res.data.status == 'logout') {
                            ...
                            if (res.data.status == 1) {
                                _this.formReset();
                                _this.vendorFormData('vendor-create-form-data');
                            }
