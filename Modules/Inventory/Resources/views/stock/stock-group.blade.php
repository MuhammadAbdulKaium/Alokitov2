        ...
        <section class="content">
            ...
            <div class="box box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a class="btn btn-success btn-sm" href="{{ url('inventory/add/stock-group') }}" data-target="#globalModal" data-toggle="modal" data-modal-size="modal-md"><i class="fa fa-plus-square"></i> New</a></div>
                </div>
{{--                {{$stockGroup}}--}}
                <div class="box-body">
                    <form action="">
