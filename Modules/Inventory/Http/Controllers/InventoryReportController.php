...
class InventoryReportController extends Controller
{
    ...
    public function searchItemLedgerReport(Request $request)
    {
        ...
        if($stores[0] == 'all'){
            ...
            $stores1 = InventoryStore::where(['institute_id' => $institute->id, 'campus_id' => $campus->id])->pluck('id')->toArray();
        }
        else{
        ...
        $products = CadetInventoryProduct::where(['category_id' => $request->productCategoryId, 
                                                'stock_group' => $request->productGroupId,
                                                'institute_id' => $institute->id,
                                                'campus_id' => $campus->id])->get();
        ...
        'cadet_stock_products.institute_id' => $institute->id,
        'cadet_stock_products.campus_id' => $campus->id,
        'cadet_inventory_store.institute_id' => $institute->id,
        'cadet_inventory_store.campus_id' => $campus->id])       
        ...
        'cadet_inventory_store.institute_id' => $institute->id,
        'cadet_inventory_store.campus_id' => $campus->id,
        'inventory_vendor_info.institute_id' => $institute->id,
        'inventory_vendor_info.campus_id' => $campus->id])      
    ...
    public function searchStockSummaryReport(Request $request)
    {
        ...
        if($request->groupId[0] == 'all'){
            $groupIds = StockGroup::where(['institute_id' => $institute->id, 'campus_id' => $campus->id])->pluck('id')->toArray();
        }
        else {
        ...
        if($request->categoryId[0] == 'all'){
            $categoryIds = StockCategory::where(['institute_id' => $institute->id, 'campus_id' => $campus->id])->pluck('id')->toArray();
        }
        else {
        ...
        if($request->storeId[0] == 'all'){
            $storeIds = InventoryStore::where(['institute_id' => $institute->id, 'campus_id' => $campus->id])->pluck('id')->toArray();
        }
        else {
        ...
        if($request->productId[0] == 'all'){
            ...
            $productIds = StockInDetailsModel::where(['institute_id' => $institute->id, 'campus_id' => $campus->id, 'status' => 1])->select('item_id')->distinct()->get();
        }
        else {
        ...
        'cadet_inventory_store.institute_id' => $institute->id,
        'cadet_inventory_store.campus_id' => $campus->id,
        'cadet_inventory_stock_group.institute_id' => $institute->id,
        'cadet_inventory_stock_group.campus_id' => $campus->id,
        'cadet_inventory_uom.institute_id' => $institute->id,
        'cadet_inventory_uom.campus_id' => $campus->id]) 
        ->get();
        ...
        if($request->productId[0] == 'all'){
            ...
            $productIds = PurchaseReceiveDetailsModel::where(['institute_id' => $institute->id, 'campus_id' => $campus->id, 'status' => 1])->select('item_id')->distinct()->get();
        }
        else {
            $productIds = $request->productId;
        }
        ...
        if($request->productId[0] == 'all'){           
            $productIds = StockOutDetailsModel::where(['institute_id' => $institute->id, 'campus_id' => $campus->id, 'status' => 1])->select('item_id')->distinct()->get();
        }
        else {
            $productIds = $request->productId;
        }
        ...
        if($request->productId[0] == 'all'){           
            $productIds = IssueFromInventoryDetailsModel::where(['institute_id' => $institute->id, 'campus_id' => $campus->id, 'status' => 1])->select('item_id')->distinct()->get();
        }
        else {
            $productIds = $request->productId;
        }
