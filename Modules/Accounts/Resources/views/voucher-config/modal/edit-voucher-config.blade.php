                ...
                <div class="row" style="margin-bottom: 15px">
                    ...
                    <div class="col-sm-8">
                        <select name="type_of_voucher" id="type_of_voucher"  class="form-control" required>
                            ...
                            <option <?php if($voucher->type_of_voucher ==5) echo 'selected'; ?> value="5">Contra Voucher</option>
                            <option <?php if($voucher->type_of_voucher ==6) echo 'selected'; ?> value="6">Journal Voucher</option>
                        </select>
                    </div>
                </div>
