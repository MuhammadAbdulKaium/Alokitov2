...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                <i class="fa fa-upload"></i> Import Employee Image     </h1>
            <ul class="breadcrumb"><li><a href="/"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="/student/default/index">Employee</a></li>
                <li class="active">Import Employee Image</li>
            </ul>
        </section>
        ...
        <section class="content">
            ...
            <form id="import-student" action="/employee/image/import/upload" method="post" enctype="multipart/form-data">
