    ...
    <div class="logo-wrap">
        <div class="container-fluid">
            <div class="col-md-2" style="text-align: center">
                <a href="{{(Auth::user()->hasRole('super-admin')==true || Auth::user()->hasRole('uno')==true)?URL::to('/admin '):URL::to('/')}}">
                    ...
                    {{--                    <img src="{{URL::asset('assets/users/images/'.getInstituteProfile()->logo)}}" style="height: 70px" width="70px" align="center" class="brand-logo" alt="Alokito logo">--}}
                </a>
            </div>
            @php    $campusName = getCampusProfile(); @endphp
            <div class="col-md-4" style="margin-bottom: 5px"><h2 class="school-name">
                ...
                <span class="label label-success" style="padding: 6px">{{$campusName->name}} </span>
            </div>            {{--<div class="col-md-2"><h4 class="campus-name">{{getCampusProfile()->name}}</h4></div>--}}
...
<script src="{{URL::asset('js/jquery.timepicker.min.js')}}" type="text/javascript"></script>
