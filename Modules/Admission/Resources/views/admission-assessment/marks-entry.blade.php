...
@section('page-content')
    <form id="applicant_grade_search_form">
        <div class="row">
            <div class="col-sm-4">
...
@section('page-script')
    <script>
        $(function () {
            $('form#applicant_grade_search_form').on('submit', function (e) {
                e.preventDefault();
                // ajax request
                $.ajax({
                    type: 'GET',
                    cache: false,
                    url: '/admission/find/marks-entry',
                    data: $('form#applicant_grade_search_form').serialize(),
                    datatype: 'html',
