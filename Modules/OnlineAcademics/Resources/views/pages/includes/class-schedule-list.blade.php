        ...
        <div id="w1" style="overflow-x:auto;">
            ...
            <table id="example2" class="table table-striped table-bordered">
                ...
                <tbody>
                    @php
                    $days =
                    array(1=>'Saturday',2=>'Sunday',3=>'Monday',4=>'Tuesday',5=>'Wednesday',6=>'Thursday',7=>'Friday');
            ...
            success: function (data) {
                ...
                if (data.tabActive == 'onlineclass') {
                    ...
                    window.location.href =
                        "{{ url('/onlineacademics/onlineacademic/LiveClassScheduled/') }}/" + ScheduleId;
                }
            },
            error: function () {
                // sweet alert
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.tabActive == 'onlineclass') {
                    ...
                    window.location.href =
                        "{{ url('/onlineacademics/onlineacademic/LiveClassScheduledbroadcast/') }}/" +
                        ScheduleId;
                }
            },
            error: function () {
