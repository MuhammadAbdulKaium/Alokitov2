...
<div class="row">
    <div class="col-sm-12">
        ...
        <!--            <div style="background: yellow" class="testimonial">
                <div class="mainTestimonial">
                    <div class="row" style="width: 100%; float: left;">
                        <div class="topHeadingLeft col-sm-4" style="width: 32%; float: left">ক্রমিক নং: 1<br>কেন্দ্র
                            কোড:{{$instituteProfile->center_code}}<br>জেলা কোড: {{$instituteProfile->zilla_code}}</div>

                        <div class="topHeadingMiddle col-sm-4" style="width: 32%; float: left">বিদ্যালয়ের
                            কোড: {{$instituteProfile->institute_code}} <br>উপজেলা
                            কোড:{{$instituteProfile->upazila_code}} </div>

                        <div class="topHeadingRight col-sm-4" style="width: 20%; float: right">
            ...
            <div class="footerSection" style="margin-top: 30px">
                <div class="row" style="width: 100%;">
                    <div class="col-sm-4 footer_left_text" style="width: 30%">-------------------------------------<br>লেখক
                        <br></div>
                    <div class="col-sm-4 footer_right_text" style="width: 30%; float: right; margin-top: -50px">
