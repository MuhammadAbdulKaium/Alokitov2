...
class StudentPhotoController extends Controller
{
    ...
    public function getStudentPsyco($id)
    {
        ...
        $studentPhoto = CadetPersonalPhoto::where('student_id',$id)->get();
        return view('student::pages.student-profile.student-photo', compact('personalInfo','studentProfile','studentPhoto'))->with('page', 'photo');

//        $studentProfile = StudentInformation::findOrFail($id);
//        return view('student::pages.student-profile.modals.photo-upload', compact('studentProfile'))->with('page', 'photo');
    }
