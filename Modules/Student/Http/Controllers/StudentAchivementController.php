...
class StudentAchivementController extends Controller
{
    ...
    public function getStudentPsyco($id)
    {
        ...
        return view('student::pages.student-profile.student-achievement', compact('personalInfo','recordInfo'))->with('page', 'achievement');
    }
