      ...
      @if (!Request::is('/'))
         ...
         <!-- Left nav -->
            <ul class="nav navbar-nav">
               ...
               <li>
                  <a href="#" class="main-menu-style">
                     <span class="fa fa-th-large icon-margin"></span> Menu
                  </a>
                  <ul class="dropdown-menus main-dropdown">
                     <li><a href="#"><span class="fa fa-book icon-margin"></span> Academics </span><span class="caret"></span></a>


                        <ul class="dropdown-menus">
{{--                           <li><a href="#"><i class="fa fa-line-chart icon-margin"></i> Course Management<span class="caret"></span></a>--}}
{{--                              <ul class="dropdown-menus">--}}
                                 <li><a href="{{url('academics/academic-year')}}"><i class="fa fa-calendar"></i> Academics Year</a></li>
                                 <li><a href="{{url('academics/admission-year')}}"><i class="fa fa-calendar"></i> Admission Year</a></li>
                                 <li><a href="{{url('academics/academic-level')}}"><i class="fa fa-graduation-cap"></i> Academics Level</a></li>
...
{{--                           </li>--}}
                     ...
                     <li><a href="#"><span class="fa fa-user icon-margin"></span> Cadets </span><span class="caret"></span></a>
...
{{--                              <ul class="dropdown-menus">--}}
                                 ...
                                 <li><a href="/student/profile/create"><i class="fa fa-user-plus"></i> Add Cadet</a></li>
                                 ...
                                 <li><a href="#"><i class="fa fa-info-circle"></i> Cadet Status</a></li>
...
{{--                           </li>--}}
                     ...
                     <li><a href="#"><span class="fa fa-wrench icon-margin"></span> Administration </span><span class="caret"></span></a>
                     <ul class="dropdown-menus">
					 ...
					 <li><a href=""><span class="fa fa-university icon-margin"> </span>Hostel<span class="caret"></span></a>
						<ul class="dropdown-menus">
							<li><a href="{{route('create_hostel')}}"><i
											class="fa fa-user-plus"></i> Create Hostel</a></li>
							<li><a href="{{route('create_facilities')}}"><i
											class="glyphicon glyphicon-object-align-bottom"></i>Create Facilities</a>
							</li>
							<li><a href="{{route('assign_hostel')}}"><i
											class="glyphicon glyphicon-equalizer"></i> Assign Hostel</a></li>

						   <li><a href="/library/library-cupboard-shelf/index"><i
										 class="glyphicon glyphicon-equalizer"></i> Collect Fees</a></li>
						   <li><a href="/library/library-cupboard-shelf/index"><i
										 class="glyphicon glyphicon-equalizer"></i> Report</a></li>
						</ul>
					</li>
                     ...
                     <li><a href="#"><span class="fa fa-cog icon-margin"></span> Setting </span><span class="caret"></span></a>
                        <ul class="dropdown-menus" >
                           ...
                           <li><a href="#"> Manage Users <span class="caret"></span></a>
                              <ul class="dropdown-menus">
                                 <li><a href="{{url('/admin/manage/users/uno')}}"><i class="fa fa-user-times"></i> Manage HighAdmin</a></li>
                              </ul>
                           </li>
                     ...
                     <li><a href="#"><span class="fa fa-cog icon-margin"></span> Role Management </span><span class="caret"></span></a>
                        <ul class="dropdown-menus" >
                           <li><a href="/role-management/users/list"><i class="fa fa-cogs"></i> Users</a></li>
                           <li><a href="/role-management/menus/list"><i class="fa fa-cogs"></i> Menu </a></li>
                        </ul>
                     </li>
                  </ul>
               </li>
