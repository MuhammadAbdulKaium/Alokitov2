            ...
            <ul class="nav navbar-nav">
               ...
               <li>
                  ...
                  <ul class="dropdown-menus main-dropdown">
                     ...
                     <li><a href="#"><span class="fa fa-money icon-margin"></span> Fees <span class="caret"></span></a>
...
<ul class="dropdown-menus">
   ...
   <li><a href="#"><i class="fa fa-line-chart" aria-hidden="true"></i> Reports <span class="caret"></span></a></li>
                     ...
                     <li><a href=""><span class="fa fa-university icon-margin"> </span>Hostel<span class="caret"></span></a>
                        ...
                        <ul class="dropdown-menus">
                           <li><a href="#"><i class="fa fa-puzzle-piece" aria-hidden="true"></i> SOP Setup <span class="caret"></span></a>
                              ...
                              <ul class="dropdown-menus">
                                 <li><a href="{{route('create_hostel')}}"><i class="fa fa-user-plus"></i> Create Hostel</a></li>
                                 <li><a href="{{route('create_facilities')}}"><i class="glyphicon glyphicon-object-align-bottom"></i>Create Facilities</a></li>
                                 <li><a href="{{route('assign_hostel')}}"><i class="glyphicon glyphicon-equalizer"></i> Assign Hostel</a></li>
                                 <li><a href="/library/library-cupboard-shelf/index"><i class="glyphicon glyphicon-equalizer"></i> Collect Fees</a></li>
                                 <li><a href="/library/library-cupboard-shelf/index"><i class="glyphicon glyphicon-equalizer"></i> Report</a></li>
                              </ul>
                     ...
                     <li><a href="#"><span class="fa fa-cog icon-margin"></span> Role Management <span class="caret"></span></a>
                        <ul class="dropdown-menus" >
