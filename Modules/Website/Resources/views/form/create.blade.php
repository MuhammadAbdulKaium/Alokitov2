    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add Online Admission Form Duration</h4>
            </div>

            <form id="add-information-form" name="add-information-form"  class="form-horizontal" action="{{url('website/form/store')}}" method="post" role="form">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="datetime-local" name="starting_date" id="starting_date" class="form-control" onchange="compareDate()" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="datetime-local" name="ending_date" id="ending_date" class="form-control" onchange="compareDate()">
                            </div>
                        </div>
                    </div>
