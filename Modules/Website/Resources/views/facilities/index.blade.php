                    ...
                    <div class="box box-solid">
                        <div>
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-search"></i>View Website Facility</h3>
                                <div class="box-tools">
                                    ...
                                    <div id="w1" class="grid-view">
                                        <table id="myTable" class="table table-striped table-bordered text-center">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr class="gradeX">
                                                        <td>{{$i++}}</td>
                                                        <td><img height="80" src="/images/{{$photos[$i-2]}}" alt=""></td>
                                                        <td>{{$facility->name}}</td>
                                                        <td>{{substr($facility->description, 0, 50)}}....</td>
                                                        <td>
                                                            <a href="{{ url('website/extra/show', [$typeArray[0], $facility->id]) }}" class="btn btn-primary btn-xs"  target="_blank">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
{{--                                                            <a href="{{ url('website/extra/edit', [$typeArray[0], $facility->id]) }}"  class="btn btn-primary btn-xs" data-target="#globalModal" data-toggle="modal" data-modal-size="modal-lg" data-content="update">--}}
{{--                                                                <i class="fa fa-edit"></i>--}}
{{--                                                            </a>--}}
                                                            <a href="{{ url('website/extra/delete',$facility->id) }}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to Delete?')" data-content="delete">
