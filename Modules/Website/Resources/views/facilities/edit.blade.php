@if($user->hasRole(['super-admin']) || $user->hasRole(['admin']))
    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            ...
            <form id="add-information-form" name="add-information-form"  class="form-horizontal" action="{{url('website/extra/update', $facility->id)}}" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input id="name" class="form-control" name="name" value="{{$facility->name}}" type="text" required>
                            </div>
                        </div>
                    </div>
