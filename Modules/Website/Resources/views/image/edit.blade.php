@if($user->hasRole(['super-admin']) || $user->hasRole(['admin']))
    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            ...
            <form id="add-information-form" name="add-information-form"  class="form-horizontal" action="{{url('website/image/update', $album->id)}}" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input name="name" id="name" class="form-control" type="text" value="{{$album->name}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                <label class="control-label" for="file">Add More Images</label>
