    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add Extra Curricular Activities</h4>
            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select id="curricular_type" class="form-control academicLevel" name="curricular_type" required>
                                    <option value="" disabled selected hidden>--Select Extra Curricular Type--</option>
