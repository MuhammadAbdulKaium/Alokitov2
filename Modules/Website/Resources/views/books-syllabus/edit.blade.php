    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Edit Book $ Syllabus</h4>
            </div>

            <form id="add-information-form" name="add-information-form"  class="form-horizontal" action="{{url('website/extra/update', $booksSyllabus->id)}}" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input id="name" class="form-control" name="name" type="text" value="{{$booksSyllabus->name}}" required>
                            </div>
                        </div>
                    </div>
