        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input id="amount" class="form-control" name="amount" type="text" value="{{$grade->amount}}">
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input id="percentage" class="form-control" name="percentage" type="text" value="{{$grade->percentage}}">
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="col-sm-3">
